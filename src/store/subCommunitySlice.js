...
const getSucCommunityAsync = createAsyncThunk('subCommunity/getSucCommunityAsync', async (_, { rejectWithValue }) => {
    try {
...
const subCommunitySlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            .addCase(getSucCommunityAsync.fulfilled, (state, action) => {
